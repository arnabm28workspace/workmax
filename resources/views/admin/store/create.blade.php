                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="store_name" placeholder="Enter person name" class="form-control" value="{{old('store_name')}}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="bussiness_name" placeholder="Enter company name" class="form-control" value="{{old('bussiness_name')}}">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="email" placeholder="Enter email id" class="form-control" value="{{old('email')}}">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="10" name="contact" id="contact"  placeholder="Enter mobile number" class="form-control" value="{{old('contact')}}" onkeypress="validateNum(event)">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" maxlength="10" name="whatsapp" id="whatsapp" placeholder="Enter whatsapp number" class="form-control" value="{{old('whatsapp')}}" onkeypress="validateNum(event)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="credit_limit" placeholder="Credit Limit" class="form-control" onkeypress="validateNum(event)" maxlength="20" value="{{old('credit_limit')}}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="credit_days" placeholder="Credit Days" onkeypress="validateNum(event)" maxlength="5" class="form-control" value="{{old('credit_days')}}">
