...
<section>
    ...
    <form method="post" action="{{ route('admin.store.update', $id) }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" @if($data->is_wa_same == 1) checked @endif value="1" name="is_wa_same" id="checkWhatsappSame">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="address" id="address" placeholder="" class="form-control">{{$data->address}}</textarea>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="state" placeholder="" id="state" class="form-control" value="{{$data->state}}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="city" placeholder="" id="city" class="form-control" value="{{$data->city}}">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="pin" placeholder="" id="pin" class="form-control" value="{{$data->pin}}">
