    ...
    <div class="row">
                    ...
                    <div class="col-auto">
                        <form action="" method="GET">
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-auto">
                                <a href="{{ route('admin.storeWiseReport') }}" class="btn btn-outline-danger btn-sm">Clear</a>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="col-xl-6">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($store_sales_data as $productKey => $product)
                    <tr>
                        <td>1</td>
