        ...
        <div class="col-sm-12">
            <div class="search__filter">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto">                        
                        <form action="{{ route('admin.invoice.store',$id) }}" id="searchForm">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>        
                        ...
                        <td>
                            <a href="{{ route('admin.invoice.payments', [$item->id,$item->store_id,'store'] ) }}" class="btn btn-sm btn-success">View</a>
                        </td>
                    </tr>
                    @empty
