...
class CartRepository implements CartInterface
{
    ...
    //      $cartExists = Cart::where('product_id', $collectedData['product_id'])->where('user_id', $collectedData['user_id'])->first();
    //      $productImage = $collectedData['product_image'];
    //      if ($cartExists) {
    //          $cartExists->qty = $collectedData['qty'];
    //          $cartExists->save();
    //         //  dd('$cartExists',$cartExists);
    //          return $cartExists;
    //     } else {
    //         $newEntry = new Cart;
    ...
    {
        $data = Cart::where('user_id', Auth::user()->id)->latest('id', 'desc')->get();
